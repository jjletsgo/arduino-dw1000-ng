 ...
 * Modified to support 4 anchors (A, B, C, D) and Bluetooth data transmission
 */
 ...
 void setup() {
     // DEBUG monitoring
     Serial.begin(115200);
     Serial.println(F("### DW1000Ng-arduino-ranging-tag (4 Anchors) ###"));
 ...
 void loop() {
     ...
     if(res.success) {
         ...
         Serial.println("Full ranging cycle successful!");
     } else {
         Serial.println("Ranging cycle failed after all anchor retries");
     }
 }
